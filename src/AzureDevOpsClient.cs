...
public sealed class AzureDevOpsClient : IDisposable
{
    ...
    /// </summary>
    /// <param name="org">The Azure DevOps organization name (e.g., "myorg").</param>
    /// <param name="project">The Azure DevOps project name or ID.</param>
    public static AzureDevOpsClient Create(string org, string project)
    {
    ...
    /// </summary>
    /// <param name="folder">The pipeline folder path (e.g., <c>\myorg\myrepo</c>).</param>
