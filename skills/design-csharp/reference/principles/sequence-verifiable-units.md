...
This principle complements [Prove It Works](./prove-it-works.md), which keeps each check real, and [Build the Lever](./build-the-lever.md), which makes the per-unit check cheap.
