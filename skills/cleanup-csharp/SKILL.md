...
2. Spawn one GPT-5.6 Luna sub-agent using `reference/scanner-prompt.md`. Fill
   in the placeholders before sending it to the sub-agent. Tell it what to scan
   (which files or what diff).
